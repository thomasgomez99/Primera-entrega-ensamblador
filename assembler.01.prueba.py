...
------------------------------------------------
- Lee un .asm con código RV32I y produce .hex (32b/linea) y .bin (agrupado por campos).
...
# ======= NUEVO: binario agrupado por formato (R/I/S/B/U/J) =======
...
def main(argv=None):
    ...
    with open(bin_path, 'w', encoding='utf-8') as f:
        for w in words:
            # >>> cambio: usamos bin agrupado por campos <<<
            f.write(format_bin_grouped(w) + "\n")
